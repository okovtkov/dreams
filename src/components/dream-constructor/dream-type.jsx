...
export default class DreamType extends React.Component {
  render() {
    return (
      <>
        ...
        <ul className={css.list}>
          <li className={css.item}>
            <button className={css.button} onClick={() => this.props.onChangeType('video')} disabled>
              <IconVideo />
          ...
          <li className={css.item}>
            <button className={css.button} onClick={() => this.props.onChangeType('text')}>
              <IconMessage />
              <span className={css.variant}>
                Write a text dream
              </span>
